...
{
    internal static class RemoteRuntimeDebuggerModelMapper
    {
        public static RuntimeHierarchySnapshot ToRuntime(RemoteDebuggerHierarchyResponse response)
        {
        ...
        private static RuntimeMaterialSlotDescriptor ToRuntime(RemoteMaterialSlotDescriptor slot)
        {
            ...
            for (int i = 0; i < sourceProperties.Length; i++)
            {
                ...
                properties[i] = new RuntimeShaderPropertyView
                {
                    ...
                    HasDebuggerOverride = property.HasDebuggerOverride
                };
            }
