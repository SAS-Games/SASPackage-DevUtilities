...
{
    internal sealed class EditorLanDiscoveryService : IDisposable
    {
        ...
        public void Start()
        {
            ...
            try
            {
                ...
                listener.Client.Bind(new IPEndPoint(IPAddress.Any, RemoteProtocolConstants.LanDiscoveryPort));
            ...
            {
                Error = $"LAN discovery could not listen on UDP port {RemoteProtocolConstants.LanDiscoveryPort}: {exception.Message}";
                DisposeListener();
            }
        }
