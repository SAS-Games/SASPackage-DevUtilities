...
namespace SAS.Utilities.RemoteDevUtilities.Protocol.RuntimeDebugger
{
    [Serializable]
    public sealed class RemoteDebuggerHierarchyRequest
    {
        public bool ForceRefresh;
    }

    [Serializable]
    public sealed class RemoteDebuggerHierarchyResponse
    {
    ...
    [Serializable]
    public sealed class RemoteDebuggerInspectRequest
    {
        public long ObjectId;
    }

    [Serializable]
    public sealed class RemoteDebuggerInspectResponse
    {
        public bool Found;
        public string Error;
    ...
    public sealed class RemoteMaterialSlotDescriptor
    {
        ...
        public bool IsDebuggerMaterialInstance;
    ...
    public sealed class RemoteShaderPropertyView
    {
        ...
        public bool ReadOnly;
        public bool HasDebuggerOverride;
    }

    public enum RemoteDebuggerCommandKind
    {
        SetGameObjectActive,
        SetComponentEnabled,
        SetMemberValue,
    ...
    [Serializable]
    public sealed class RemoteDebuggerCommandRequest
    {
        public RemoteDebuggerCommandKind Kind;
        public long ObjectId;
    ...
    [Serializable]
    public sealed class RemoteDebuggerCommandResponse
    {
        public bool Success;
