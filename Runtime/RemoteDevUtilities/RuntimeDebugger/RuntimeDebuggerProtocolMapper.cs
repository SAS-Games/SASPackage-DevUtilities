...
{
    internal static class RuntimeDebuggerProtocolMapper
    {
        public static RemoteDebuggerHierarchyResponse ToRemote(RuntimeHierarchySnapshot snapshot)
        {
            if (snapshot == null)
                return new RemoteDebuggerHierarchyResponse();
        ...
        private static RemoteMaterialSlotDescriptor ToRemote(RuntimeMaterialSlotDescriptor slot)
        {
            ...
            for (int i = 0; i < sourceProperties.Count; i++)
            {
                ...
                properties[i] = new RemoteShaderPropertyView
                {
                    ...
                    HasDebuggerOverride = view.HasDebuggerOverride
                };
            }
            ...
            return new RemoteMaterialSlotDescriptor
            {
                ...
                IsDebuggerMaterialInstance = slot.IsDebuggerMaterialInstance,
