...
{
    [CreateAssetMenu(
        fileName = "GraphicsInfoCommand",
        menuName =
            DeveloperConsole.CommandBasePath + "GraphicsInfo")]
    public class GraphicsInfoCommand : ConsoleCommand
    {
            ...
            string[] args = null)
        {
            ...
            GraphicsInfoSnapshotProvider snapshotProvider =
                _graphics.GetComponent<GraphicsInfoSnapshotProvider>();
            if (snapshotProvider == null)
                return false;

            snapshotProvider.SetRequestedState(
                isVisible,
                verbose);
