...
namespace SAS.Utilities.RuntimeDebugger
{
    ...
    {
        private const string ShaderEditValueControlName = "RuntimeDebugger.ShaderEditValue";
        ...
        internal RuntimeMaterialShaderInspectorView(RuntimeDebuggerController controller,
            RuntimeDebuggerSettings settings, RuntimeDebuggerTheme theme)
        {
            ...
            ref int rowIndex)
        {
            ...
            GUILayout.Label($"Queue: {slot.RenderQueue}   Instancing: {slot.EnableInstancing}   " +
                            ...
                            (slot.IsDebuggerMaterialInstance ? "   DEBUGGER INSTANCE" : string.Empty),
                _theme.Muted);
