...
{
    internal enum RuntimeDebuggerPanel
    {
        Search,
        Hierarchy,
        Inspector
    ...
    internal sealed class RuntimeDebuggerView : IDisposable
    {
        ...
        private readonly RuntimeDebuggerController _controller;
        ...
        internal RuntimeDebuggerView(RuntimeDebuggerController controller, RuntimeDebuggerSettings settings)
        {
        ...
        private void DrawWindow(int id)
        {
            ...
            GUILayout.Label("RUNTIME DEBUGGER", _theme.Title);
        ...
        {
            GUILayout.BeginHorizontal(_theme.Toolbar);
            DrawPanelTab("SEARCH", RuntimeDebuggerPanel.Search, 88f);
            DrawPanelTab("HIERARCHY", RuntimeDebuggerPanel.Hierarchy, 104f);
            DrawPanelTab("INSPECTOR", RuntimeDebuggerPanel.Inspector, 96f);
            GUILayout.FlexibleSpace();
            GUILayout.Label("TAB / RB  NEXT", _theme.Muted, GUILayout.Height(28f));
            GUILayout.EndHorizontal();
        }

        private void DrawPanelTab(string label, RuntimeDebuggerPanel panel, float width)
        {
