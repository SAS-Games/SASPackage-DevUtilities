...
namespace SAS.Utilities.RuntimeDebugger
{
    internal sealed class RuntimeDebuggerTheme : IDisposable
    {
        ...
        internal RuntimeDebuggerTheme(RuntimeDebuggerSettings settings)
        {
            _settings = settings;
        }
        ...
        internal void EnsureCreated()
        {
            ...
            if (_settings == null)
            {
                Debug.LogWarning("[Runtime Debugger] No RuntimeDebuggerSettings asset was assigned. " + "Expected Assets/Resources/RuntimeDebuggerSettings.asset.");
            }
            else if (_settings.RegularFont == null)
            {
                Debug.LogWarning("[Runtime Debugger] No regular font has been assigned to RuntimeDebuggerSettings. " + "The debugger will fall back to the default GUI font.");
            }
