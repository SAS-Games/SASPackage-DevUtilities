...
namespace SAS.Utilities.RuntimeDebugger.Core
{
    internal sealed class RuntimeAnimatorComponentDrawer : RuntimeComponentDrawer<Animator>
    {
        public RuntimeAnimatorComponentDrawer(RuntimeValueDrawerRegistry valueDrawers) : base(valueDrawers)
        {
            ...
            Add("@unity.updateMode", "Update Mode", animator => animator.updateMode,
                (animator, value) => animator.updateMode = value);
            Add("@unity.cullingMode", "Culling Mode", animator => animator.cullingMode,
                (animator, value) => animator.cullingMode = value);
            Add("@unity.speed", "Speed", animator => animator.speed, (animator, value) => animator.speed = value);
            Add("@unity.fireEvents", "Fire Events", animator => animator.fireEvents,
                (animator, value) => animator.fireEvents = value);
            Add("@unity.keepAnimatorStateOnDisable", "Keep State On Disable",
                animator => animator.keepAnimatorStateOnDisable,
                (animator, value) => animator.keepAnimatorStateOnDisable = value);
            Add("@unity.stabilizeFeet", "Stabilize Feet", animator => animator.stabilizeFeet,
                (animator, value) => animator.stabilizeFeet = value,
                animator => animator.isHuman);
            AddReadOnly("@unity.runtimeAnimatorController", "Runtime Animator Controller",
