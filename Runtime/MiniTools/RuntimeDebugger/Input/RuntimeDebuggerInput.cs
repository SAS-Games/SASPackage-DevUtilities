...
namespace SAS.Utilities.RuntimeDebugger.Input
{
    ...
    public sealed class InputSystemRuntimeDebuggerInput : IRuntimeDebuggerInput, IDisposable
    {
        [Flags]
        private enum Signal
        {
        ...
        public InputSystemRuntimeDebuggerInput(RuntimeDebuggerSettings settings)
        {
            _settings = settings;
