...
namespace HP.Utilities.RuntimeSceneInspector
{
    ...
    internal sealed class RuntimeSceneInspectorHierarchyController
    {
        private static readonly ProfilerMarker RebuildMarker = new("RuntimeSceneInspector.UI.Rebuild");
        ...
        internal RuntimeSceneInspectorHierarchyController(IRuntimeSceneInspector service) => _service = service;
