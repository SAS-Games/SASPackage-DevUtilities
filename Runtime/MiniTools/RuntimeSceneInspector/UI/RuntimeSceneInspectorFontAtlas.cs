...
namespace HP.Utilities.RuntimeSceneInspector
{
    ...
    /// </summary>
    internal sealed class RuntimeSceneInspectorFontAtlas
    {
        private readonly HashSet<int> _reportedMissingCharacters = new();

        /// <summary>
        /// Checks all currently visible Scene Inspector text against the assigned fonts.
        /// Only active in Editor and Development builds.
        /// </summary>
        internal void ValidateVisibleCharacters(Font regularFont, Font boldFont, RuntimeSceneInspectorController controller)
        {
            if (controller == null)
                return;
            ...
            Validate(boldFont, "RUNTIME SCENE INSPECTOR");
