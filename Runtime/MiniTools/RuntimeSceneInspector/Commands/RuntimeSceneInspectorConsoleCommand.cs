...
namespace HP.Utilities.DeveloperConsole
{
    ...
    {
        public override string HelpText => "Usage: RuntimeSceneInspector <On|Off>. Enables or fully suspends the runtime scene inspector.";
        ...
        public override bool Process(DeveloperConsoleBehaviour developerConsole, string command, string[] args)
        {
            ...
            return true;
#else
            Debug.LogWarning("Runtime Scene Inspector is not available. Enable ENABLE_DEBUG or use a Development Build.");
            return false;
#endif
        }
    }
