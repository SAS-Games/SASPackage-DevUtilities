...
namespace SAS.Utilities.RemoteDevUtilities.Editor.MiniTools
{
    ...
    [RemoteEditorFeature("mini-tools", 300)]
    internal sealed class RemoteMiniToolClient : IRemoteEditorFeatureClient
    {
        ...
        {
            RemoteMiniToolMessageTypes.CatalogResponse,
            RemoteMiniToolMessageTypes.SubscriptionResponse,
            RemoteMiniToolMessageTypes.ActionResponse,
            RemoteMiniToolMessageTypes.Sample,
            RemoteMiniToolMessageTypes.StreamBatch
        };
        ...
        {
            _session.Send(RemoteMiniToolMessageTypes.CatalogRequest, new RemoteMiniToolCatalogRequest());
        }
        ...
        private void SendAggregatedSubscription(string toolId)
        {
            ...
            _session.Send(RemoteMiniToolMessageTypes.SubscriptionRequest, new RemoteMiniToolSubscriptionRequest
            {
                ToolId = toolId,
                Subscribe = subscribe,
        ...
        public void ExecuteAction(string toolId, string actionId)
        {
            ...
            _session.Send(RemoteMiniToolMessageTypes.ActionRequest, new RemoteMiniToolActionRequest
            {
                ToolId = toolId,
                ActionId = actionId
            });
        ...
        public void Handle(RemoteEnvelope envelope)
        {
            ...
            {
                case RemoteMiniToolMessageTypes.CatalogResponse:
                    ...
                    break;
                case RemoteMiniToolMessageTypes.SubscriptionResponse:
                    ...
                    break;
                case RemoteMiniToolMessageTypes.ActionResponse:
                    ...
                    break;
                case RemoteMiniToolMessageTypes.Sample:
                    ...
                    break;
                case RemoteMiniToolMessageTypes.StreamBatch:
