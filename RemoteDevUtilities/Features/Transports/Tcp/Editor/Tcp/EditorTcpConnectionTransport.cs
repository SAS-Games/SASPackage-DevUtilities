...
namespace SAS.Utilities.RemoteDevUtilities.Editor.Connection.Tcp
{
    internal sealed class EditorTcpConnectionTransport : IRemoteEditorTransport
    {
        ...
        public string Id => RemoteEditorTransportIds.Tcp;
        public RemoteEditorConnectionKind Kind => RemoteEditorConnectionKind.DirectTcp;
        ...
        {
            Connect(request?.Host, request?.Port ?? 0);
        }
