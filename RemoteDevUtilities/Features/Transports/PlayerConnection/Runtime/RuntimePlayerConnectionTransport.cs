...
namespace SAS.Utilities.RemoteDevUtilities.Transport
{
    internal sealed class RuntimePlayerConnectionTransport : IRuntimeRemoteTransport
    {
        ...
        public void Start()
        {
            ...
            _connection.Register(RemotePlayerConnectionProtocol.EditorToPlayerMessageId, _callbackHost.OnMessage);
        ...
        public void Send<T>(string messageType, long requestId, T payload)
        {
            ...
            _connection.Send(RemotePlayerConnectionProtocol.PlayerToEditorMessageId, data);
        }
        ...
        public void Dispose()
        {
            ...
            _connection.Unregister(RemotePlayerConnectionProtocol.EditorToPlayerMessageId, _callbackHost.OnMessage);
